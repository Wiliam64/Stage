 ...
 */
final class Version20200429214732 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE equipments (id INT AUTO_INCREMENT NOT NULL, project_id INT DEFAULT NULL, typeequipment_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, init VARCHAR(50) NOT NULL, INDEX IDX_6F6C2544166D1F9C (project_id), INDEX IDX_6F6C254444DB8C91 (typeequipment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE states (id INT AUTO_INCREMENT NOT NULL, equipment_id INT DEFAULT NULL, typestate_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, groupe INT NOT NULL, INDEX IDX_31C2774D517FE9FE (equipment_id), INDEX IDX_31C2774D59B1B249 (typestate_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_states (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(80) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE equipments ADD CONSTRAINT FK_6F6C254444DB8C91 FOREIGN KEY (typeequipment_id) REFERENCES type_equipments (id)');
        ...
        $this->addSql('ALTER TABLE states ADD CONSTRAINT FK_31C2774D59B1B249 FOREIGN KEY (typestate_id) REFERENCES type_states (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE equipments DROP FOREIGN KEY FK_6F6C254444DB8C91');
        $this->addSql('ALTER TABLE states DROP FOREIGN KEY FK_31C2774D59B1B249');
        ...
        $this->addSql('DROP TABLE type_states');
